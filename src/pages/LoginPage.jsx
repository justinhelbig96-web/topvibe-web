...
// Album art placeholders â€” real trending covers from Spotify CDN
const TILES = [
...
const HOW = [
  ...
  },
  {
    ...
    desc: 'Fire or skip â€” 30-second previews let you judge fast.',
  },
  {
    step: '03',
    ...
    <div className="sp-page">
      ...
      <section className="sp-hero">
        <div className="sp-hero__content">
          ...
          <p className="sp-hero__legal">Free forever Â· No credit card needed</p>
        </div>
        ...
        <div className="sp-feature__inner">
          <div className="sp-feature__text">
            ...
            <p className="sp-feature__desc">
              Every vote counts. Tracks with the most fire votes climb the global leaderboard â€” updated in real time. No curators, no algorithms. Just the crowd.
            </p>
          ...
          <div className="sp-feature__visual">
            <div className="sp-leaderboard-mock">
              {['Espresso Â· Sabrina Carpenter', 'Die With A Smile Â· Lady Gaga', 'APT. Â· Rose & Bruno Mars', 'Birds Of A Feather Â· Billie Eilish'].map((t, i) => (
                <div key={t} className="sp-lb-row">
                  <span className="sp-lb-rank">#{i + 1}</span>
                  <span className="sp-lb-fire">ðŸ”¥</span>
      ...
      <footer className="sp-footer">
        <div className="sp-footer__inner">
          ...
          <span className="sp-footer__copy">Â© 2025 TopVibe</span>
        </div>
      </footer>
    </div>
  );
