  ...
  return (
    <div className="login-page">
      <div className="login-card">
        <img src={logo} alt="TopVibe" className="login-logo" />
        <h1 className="login-title">TopVibe</h1>
        <p className="login-subtitle">
          Discover music. Vote for your favorites.<br />Check who vibes the hardest.
        </p>
        <a href={SPOTIFY_AUTH_URL} className="spotify-btn">
